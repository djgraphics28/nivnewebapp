       ...
       <div class="row">
           <div class="col-lg-12">
               <div class="card card-primary card-outline">
                  ...
                  <button wire:click.prevent="addNew()" class="btn btn-primary float-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New Category</button>
                   </div>
                   <div class="card-body">
                       ...
                       @endif
                           ...
                           <h6 class="card-title">Categories Datatables</h6>
                           <table class="table table-bordered table-hover">
                               ...
                               <tbody>
                                   @foreach ($categories as $data)
                                       <tr>
                                           <td><input type="checkbox" value="{{ $data->id }}" wire:model="checkedCategory"></td>
       ...
       <div class="modal-content">
           ...
           <div class="modal-body">
               ...
               <div class="form-group">
                   ...
                   <input type="text" wire:model.defer="category_name" class="form-control @error('category_name') is-invalid @enderror" placeholder="Enter Category Name">
                   @error('category_name')
